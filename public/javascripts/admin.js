document.addEventListener("DOMContentLoaded", function () {
  ...
  function openDeleteModal(doctorId) {
    document.getElementById("confirmDeleteBtn").style.backgroundColor = "red";
    document.getElementById("confirmDeleteBtn").style.border = "none";
    document.getElementById("confirmDeleteBtn").style.borderRadius = "15px";
    document.getElementById("confirmDeleteBtn").style.color="white";
    document.getElementById("confirmDeleteBtn").style.height = "30px";
